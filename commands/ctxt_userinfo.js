const { ContextMenuCommandBuilder, ApplicationCommandType, EmbedBuilder, Application } = require('discord.js');
...
module.exports = {
    ...
    async execute(interaction, Discord, client, version, helper, db_gen, db_ud) {
        ...
        if (!interaction.replied) return interaction.reply({ embeds: [finalEmbed], ephemeral: true });
    }
}